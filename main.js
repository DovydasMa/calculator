...
const showDisplay = display => document.getElementById("display").innerHTML = display;
...
const processExpression = str => compose(maybe("missing number", arrNumOp),checkSecondNumber,splitNumbersOperators,maybe("Please enter something", onlyNumbersOperators ))(Maybe.of(str));
const calculateResult =( { numbers, operators } )=> compose(showDisplay, calculate)({ numbers, operators }); 
const arrNumOp = str =>{
